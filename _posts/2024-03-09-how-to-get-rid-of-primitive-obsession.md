...
description: Why relying on raw strings, ints and bools instead of dedicated types, Primitive Obsession, makes C# code fragile, and how to replace them with value objects.
